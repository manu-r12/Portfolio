...
//                                 <p><span className='text-[2rem] font-semibold'>My name is Manu Rajbhar</span>, but you can call me MR :) I am a software developer interested in building iOS and web apps, coding video games, and training machine learning models.</p>
